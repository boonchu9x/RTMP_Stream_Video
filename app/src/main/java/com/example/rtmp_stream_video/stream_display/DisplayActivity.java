...
import com.example.rtmp_stream_video.Constant;
import com.example.rtmp_stream_video.R;
...
public class DisplayActivity extends AppCompatActivity
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_STREAM
            ...
            intent.putExtra("endpoint", Constant.URL_SERVER_LIVESTREAM + Constant.SERVER_NAME);
            startService(intent);
        } else {
